...
const ProjectsGallery: React.FC<ProjectsGalleryProps> = ({ onBack }) => {
  ...
  const projects: Project[] = [
    { 
      ...
      category: 'Branding', 
      image: '/src/assets/osprimos1.jpg', 
      modalImage: '/src/assets/osprimos1.jpg',
      ...
      images: [
        '/src/assets/osprimos1.jpg',
        '/src/assets/osprimos2.jpg',
        '/src/assets/osprimos3.jpg',
      ],
    },
    { 
      id: 2,
      ...
      category: 'Web',
      image: '/src/assets/ultra.jpg',
      modalImage: '/src/assets/ultra2.jpg',
      ...
      images: ['/src/assets/ultra.jpg', '/src/assets/ultra2.jpg']
    },
    { 
      id: 3,
      title: 'Teatro Vila Real – App Fictícia',
      category: 'Mobile',
      image: '/src/assets/teatro.jpg', // substitui pelo caminho correto da imagem de capa
      modalImage: '/src/assets/teatro2.jpg', // substitui pelo detalhe/modal, se houver
      ...
      images: [
        ...
        '/src/assets/teatro2.jpg',
        '/src/assets/teatro3.jpg',
      ],
    },
    { 
      id: 4, 
      ...
      modalImage: '/src/assets/project3.jpg',
      ...
      images: ['/src/assets/project3.jpg'],
    },
    { 
      id: 5, 
      ...
      modalImage: '/src/assets/project4.jpg',
      ...
      images: ['/src/assets/project4.jpg'],
    },
    { 
      id: 6, 
      ...
      modalImage: '/src/assets/project5.jpg',
      ...
      githubUrl: 'https://github.com/exemplo',
      liveUrl: 'https://exemplo.com',
      images: ['/src/assets/project5.jpg'],
    },
    { 
      id: 7,
      title: 'Associação 31 – Cartazes',
      category: 'Branding',
      image: '/src/assets/infantario.png',
      modalImage: '/src/assets/infantario2.jpg',
      ...
      liveUrl: undefined,
      images: ['/src/assets/infantario.png', '/src/assets/infantario2.jpg'],
    },
    { 
      id: 8, 
      title: 'SaaS Platform', 
      category: 'Web', 
      image: '/src/assets/project7.jpg', 
      modalImage: '/src/assets/project7.jpg',
      ...
      githubUrl: 'https://github.com/exemplo',
      liveUrl: 'https://exemplo.com',
      images: ['/src/assets/project7.jpg'],
    },
    { 
      id: 9, 
      title: 'Fitness App', 
      category: 'Mobile', 
      image: '/src/assets/project8.jpg', 
      modalImage: '/src/assets/project8.jpg',
      ...
      liveUrl: 'https://exemplo.com',
      images: ['/src/assets/project8.jpg'],
    },
    { 
      id: 10, 
      title: 'Chatbot Interface', 
      category: 'IA', 
      image: '/src/assets/project9.jpg', 
      modalImage: '/src/assets/project9.jpg',
      ...
      githubUrl: 'https://github.com/exemplo',
      images: ['/src/assets/project9.jpg'],
    },
    { 
      id: 11, 
      title: 'Portfolio Website', 
      category: 'Web', 
      image: '/src/assets/project10.jpg', 
      modalImage: '/src/assets/project10.jpg',
      ...
      liveUrl: 'https://exemplo.com',
      images: ['/src/assets/project10.jpg'],
    },
    { 
      id: 12, 
      title: 'Travel App', 
      category: 'Mobile', 
      image: '/src/assets/project11.jpg', 
      modalImage: '/src/assets/project11.jpg',
      ...
      githubUrl: 'https://github.com/exemplo',
      liveUrl: 'https://exemplo.com',
      images: ['/src/assets/project11.jpg'],
    },
    { 
      id: 13, 
      title: 'Logo Design', 
      category: 'Branding', 
      image: '/src/assets/project12.jpg', 
      modalImage: '/src/assets/project12.jpg',
      ...
      liveUrl: 'https://exemplo.com',
      images: ['/src/assets/project12.jpg'],
    },
    { 
      id: 14, 
      title: 'Analytics Dashboard', 
      category: 'Web', 
      image: '/src/assets/project13.jpg', 
      modalImage: '/src/assets/project13.jpg',
      ...
      githubUrl: 'https://github.com/exemplo',
      images: ['/src/assets/project13.jpg'],
    },
    { 
      id: 15, 
      title: 'Social Media App', 
      category: 'Mobile', 
      image: '/src/assets/project14.jpg', 
      modalImage: '/src/assets/project14.jpg',
      ...
      liveUrl: 'https://exemplo.com',
      images: ['/src/assets/project14.jpg'],
    },
    { 
      id: 16, 
      title: 'ML Prediction Tool', 
      category: 'IA', 
      image: '/src/assets/project15.jpg', 
      modalImage: '/src/assets/project15.jpg',
      ...
      githubUrl: 'https://github.com/exemplo',
      images: ['/src/assets/project15.jpg'],
    },
    { 
      id: 17, 
      title: 'E-learning Platform', 
      category: 'Web', 
      image: '/src/assets/project16.jpg', 
      modalImage: '/src/assets/project16.jpg',
      ...
      githubUrl: 'https://github.com/exemplo',
      images: ['/src/assets/project16.jpg'],
    },
    { 
      id: 18, 
      title: 'Shopping App', 
      category: 'Mobile', 
      image: '/src/assets/project17.jpg', 
      modalImage: '/src/assets/project17.jpg',
      ...
      liveUrl: 'https://exemplo.com',
      images: ['/src/assets/project17.jpg'],
    },
    { 
      id: 19, 
      title: 'Visual Identity', 
      category: 'Branding', 
      image: '/src/assets/project18.jpg', 
      modalImage: '/src/assets/project18.jpg',
      ...
      liveUrl: 'https://exemplo.com',
      images: ['/src/assets/project18.jpg'],
    },
    { 
      id: 20, 
      title: 'CRM System', 
      category: 'Web', 
      image: '/src/assets/project19.jpg', 
      modalImage: '/src/assets/project19.jpg',
      ...
      githubUrl: 'https://github.com/exemplo',
      liveUrl: 'https://exemplo.com',
      images: ['/src/assets/project19.jpg'],
    },
    { 
      id: 21, 
      title: 'Voice Assistant', 
      category: 'IA', 
      image: '/src/assets/project20.jpg', 
      modalImage: '/src/assets/project20.jpg',
      ...
      githubUrl: 'https://github.com/exemplo',
      images: ['/src/assets/project20.jpg'],
    }
  ];
